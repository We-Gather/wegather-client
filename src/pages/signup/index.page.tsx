...
export default function SignUp(): JSX.Element {
	...
	return (
		<div>
			{step === 1 && <SignUpBasicInformationForm handleNext={handleNext} />}
			{step === 2 && <SignUpEmailVerificationForm handleNext={handleNext} handlePrev={handlePrev} />}
			{step === 3 && <SignUpCompleteForm />}
		</div>
	);
}
